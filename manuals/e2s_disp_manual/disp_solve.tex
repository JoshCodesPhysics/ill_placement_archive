...
% If you do not wish for the input files to be in the same directory, you must
% replace the name of the input file, and the filenames within the input file,
% with the full path directory address of each one.
